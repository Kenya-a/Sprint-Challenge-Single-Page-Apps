...
> Answer: Because less data is being processed client-side routing allows routing between view to be faster. This makes transitioning between views easier to achieve.
